...
/** 
 * @file ConflictCheckerOneTwoSIMDARM.hpp
 * @brief defines functions that check conflicting variables during the 2-1 exchange 
...
#include <arm_neon.h>
 ...
 namespace spp{
   ...
   /**
     * @brief checks conflict in a 1-2 exchange move (one variables is set to '0' and two variables are set to '1') 
