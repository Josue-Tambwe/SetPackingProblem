...
/** 
 * @file ConflictCheckerZeroOneSIMDARM.cpp
 * @author Josué Tambwe
 * @date 3 June 2026
 */
...
namespace spp{
    ...
    bool checkConflictZeroOneMoveNEON(const size_t &nb_words,
        ...
        if(!checkConflictZeroOneMoveNEON_X4(cursor, 
                                           nb_words,
                                           to_activate, 
                                           consumed_resources)){
        ...
        if((cursor + 3) < nb_words){
            ...
            if(!checkConflictZeroOneMoveNEON_X2(cursor,
                                               to_activate, 
                                               consumed_resources)){
        ...
        if((cursor + 1) < nb_words){
            ...
            if(!checkConflictZeroOneMoveNEON_X1(cursor,
                                               to_activate, 
                                               consumed_resources)){
        ...
        if(cursor < nb_words){
            ...
            if(!checkConflictZeroOneMoveNEONTail(cursor,
                                                to_activate, 
                                                consumed_resources)){
